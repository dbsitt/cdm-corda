...
@InitiatingFlow
@StartableByRPC
class ExecutionFlowJson(val executionJson: String) : FlowLogic<SignedTransaction>() {
...
@InitiatedBy(ExecutionFlowJson::class)
class ExecutionFlowJsonInitiated(val flowSession: FlowSession) : FlowLogic<SignedTransaction>(){
