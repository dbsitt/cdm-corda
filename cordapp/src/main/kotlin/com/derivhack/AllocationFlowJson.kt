...
@InitiatingFlow
@StartableByRPC
class AllocationFlowJson(val allocationJson: String) : FlowLogic<SignedTransaction>() {
...
@InitiatedBy(AllocationFlowJson::class)
class AllocationFlowJsonInitiated(val flowSession: FlowSession) : FlowLogic<SignedTransaction>(){
