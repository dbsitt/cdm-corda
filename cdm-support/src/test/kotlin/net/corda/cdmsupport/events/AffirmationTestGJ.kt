...
class AffirmationTestGJ : BaseEventTestGJ() {
    ...
    fun affirmation() {
        ...
        val jsonText1 = readTextFromFile("/${samplesDirectory}/UC1_Block_Trade_BT4.json");
        ...
        val jsonText2 = readTextFromFile("/${samplesDirectory}/UC2_Allocation_Trade_AT4.json")
        ...
        val jsonText3 = readTextFromFile("/${samplesDirectory}/UC3_Affirmation_AT4.1.json")
        ...
        println("-------------------global referenceeee-------------------------")
        println(affExec.globalReference)
        println("-------------------global referenceeee-------------------------")
        val future3 = node8.services.startFlow(AffirmationFlow(affExec.globalReference)).resultFuture
        val tx = future3.getOrThrow().toLedgerTransaction(node8.services)
        ...
        assertTrue(tx.commands.get(0).signers.containsAll(listOf(party8.owningKey, party2.owningKey)))
    }
